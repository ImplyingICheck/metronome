...
class TixWidget(tkinter.Widget):
    def __init__(self, master: tkinter.Misc | None = ..., widgetName: str | None = ..., static_options: list[str] | None = ..., cnf: dict[str, Any] = ..., kw: dict[str, Any] = ...) -> None:
        ...
...
class TixSubWidget(TixWidget):
    def __init__(self, master: tkinter.Widget, name: str, destroy_physically: int = ..., check_intermediate: int = ...) -> None:
        ...
